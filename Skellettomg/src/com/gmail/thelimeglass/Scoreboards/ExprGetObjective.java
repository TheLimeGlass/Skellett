...
public class ExprGetObjective extends SimpleExpression<Objective>{
	...
	//[the] (score[ ][board]|[skellett[ ]]board) [[(of|named|from)] %-scoreboard%] objective [(for|from|of)] %string%
	//(score[ ][board]|[skellett[ ]]board) [[(of|named|from)] %-scoreboard%] %string%'s objective
	//objective %string% in (score[ ][board]|[skellett[ ]]board) [[(of|named|from)] %-scoreboard%]
