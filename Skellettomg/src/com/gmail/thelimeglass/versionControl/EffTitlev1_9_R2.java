...
public class EffTitlev1_9_R2 extends Effect {
	
	//[skellett] (send|show) [a] (1¦sub[ ]title|2¦title) [(with|from)] %string% [(with|and) [sub[ ]title] %-string%] (to|for) %players% for %timespan%(,| and| with [fade[ ]in]) %timespan% [fade[ ]in](,| and|( with| and) [fade[ ]out]) %timespan% [fade[ ]out]
	//[skellett] (send|show) %players% [a] (1¦sub[ ]title|2¦title) [(with|from)] %string% [(with|and) [sub[ ]title] %-string%] for %timespan%(,| and| with [fade[ ]in]) %timespan% [fade[ ]in](,| and|( with| and) [fade[ ]out]) %timespan% [fade[ ]out]
