...
public class ExprScoreObjective extends SimpleExpression<Objective>{
	...
	//[the] [skellett] (score[ ][board]|board) objective (from|of) score %score%
	//[the] [skellett] (score[ ][board]|board) %score%'s scores objective
	...
	public String toString(@Nullable Event e, boolean arg1) {
		return "[the] [skellett] (score[ ][board]|board) objective (from|of) score %score%";
	}
	@Override
	@Nullable
