...
/*
Todo:
- Make Llama inventory decor return in itemtype when Bensku updates Skript
- Fix redstone current and Fishing XP not being settable
- Use TabListAPI footer and header expressions
- Fix the particles
- Add admin full access username and password registry (This allows for full plugin control)
- Projectile bounce
- Map support using MapManagerAPI
- Fix Bungee YAML
- Add more SkellettProxy stuff
- SkellettProxy events
- Skellett command (With GUI)
- Skellett reload command
- SkellettProxy command support
- SkellettProxy scoreboard support
- Finish full feudal support
- Hook into HologramsAPI (Talking to pal InventiveTalent about stuff)
- Hook into NpcAPI (Huge project)
...
- Statistics support
- Support for packets https://www.spigotmc.org/resources/api-packetlistenerapi-1-7-1-8-1-9.2930/6
- JSON in books. and full book support, like pages, titles, author data, and everything books.
- Ability to upload stuff to Pastebin
- Beacon support
- EnderCrytal support
- Adding unknown command event, so like on unknown command: set unknown command message to blah
- Velocity support
- Creative control like On middle click on block:
- Being able to use the SkQuery jukebox player and stop it.
- Full worldguard support
- Full worldedit support
- Full factions support
- Full armour stand support
- Full worldborder support
