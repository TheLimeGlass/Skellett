...
public class EffTeamAddEntry extends Effect {
	...
	//[skellett] (score[ ][board]|board) add [the] entry [(from|of)] %string% to [the] [team] %team%
	...
	public String toString(@Nullable Event paramEvent, boolean paramBoolean) {
		return "[skellett] (score[ ][board]|board) add [the] entry [(from|of)] %string% to [the] [team] %team%";
	}
	@Override
