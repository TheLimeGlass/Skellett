...
public class ExprObjectiveGetScore extends SimpleExpression<Score>{
	...
	//[skellett] (score[ ][board]|board) [objective] %objective% score (for|of) [entry] %string%
	//[skellett] (score[ ][board]|board) %objective%['s] [objective['s]] score (for|of) [entry] %string%
	//[skellett] (score[ ][board]|board) [objective] %objective%['s] score (for|of) [entry] %string%
	...
	public String toString(@Nullable Event e, boolean arg1) {
		return "[skellett] (score[ ][board]|board) [objective] %objective% score (for|of) [entry] %string%";
	}
	@Override
	@Nullable
