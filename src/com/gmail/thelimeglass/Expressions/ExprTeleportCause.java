...
public class ExprTeleportCause extends SimpleExpression<PlayerTeleportEvent.TeleportCause> {
	...
	public boolean init(Expression<?>[] args, int arg1, Kleenean arg2, SkriptParser.ParseResult arg3) {
		if (!ScriptLoader.isCurrentEvent((Class)PlayerTeleportEvent.class)) {
			Skript.error((String)"You can not use TeleportCause expression in any event but on teleport!");
			return false;
		}
		return true;
	}
