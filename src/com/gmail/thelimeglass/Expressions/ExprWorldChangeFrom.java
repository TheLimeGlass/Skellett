...
public class ExprWorldChangeFrom extends SimpleExpression<World> {
	...
	public boolean init(Expression<?>[] args, int arg1, Kleenean arg2, SkriptParser.ParseResult arg3) {
		if (!ScriptLoader.isCurrentEvent((Class)PlayerChangedWorldEvent.class)) {
			Skript.error((String)"You can not use PastWorld expression in any event but world change event!");
			return false;
		}
		return true;
	}
