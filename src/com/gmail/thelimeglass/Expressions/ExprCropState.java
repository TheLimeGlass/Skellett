...
public class ExprCropState extends SimpleExpression<String> {
	...
	public boolean init(Expression<?>[] args, int arg1, Kleenean arg2, SkriptParser.ParseResult arg3) {
		if (!ScriptLoader.isCurrentEvent((Class)PlayerInteractEvent.class)) {
			Skript.error((String)"You can not use CropState expression in any event but PlayerInteractEvent!");
			return false;
		}
		return true;
	}
