...
public class ExprOITBGetHighestZombiesWave extends SimpleExpression<Integer>{
	
	//[OITB] [get] [Player]['][s][ ]High[est][ ][Zombie][s][ ]Wave of %player%
	...
	public String toString(@Nullable Event e, boolean arg1) {
		return "[OITB] [get] [Player]['][s][ ]High[est][ ][Zombie][s][ ]Wave of %player%";
	}
	@Override
	@Nullable
	protected Integer[] get(Event e) {
		...
		return new Integer[]{stats.getHighestZombiesWave()};
	}
}