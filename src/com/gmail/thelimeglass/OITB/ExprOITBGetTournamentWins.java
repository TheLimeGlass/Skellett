...
public class ExprOITBGetTournamentWins extends SimpleExpression<Integer>{
	
	//[OITB] [get] Tournament[s][ ](win[s]|won) of %player%
	...
	public String toString(@Nullable Event e, boolean arg1) {
		return "[OITB] [get] Tournament[s][ ](win[s]|won) of %player%";
	}
	@Override
	@Nullable
	protected Integer[] get(Event e) {
		...
		return new Integer[]{stats.getTournamentWins()};
	}
}