...
public class ExprOITBGetDeaths extends SimpleExpression<Integer>{
	
	//[OITB] [get] deaths of %player%
	...
	public String toString(@Nullable Event e, boolean arg1) {
		return "[OITB] [get] deaths of %player%";
	}
	@Override
	@Nullable
	protected Integer[] get(Event e) {
		...
		return new Integer[]{stats.getDeaths()};
	}
}