...
public class ExprOITBGetZombieKills extends SimpleExpression<Integer>{
	
	//[OITB] [get] zombie[ ]kills of %player%
	...
	public String toString(@Nullable Event e, boolean arg1) {
		return "[OITB] [get] zombie[ ]kills of %player%";
	}
	@Override
	@Nullable
	protected Integer[] get(Event e) {
		...
		return new Integer[]{stats.getZombieKills()};
	}
}