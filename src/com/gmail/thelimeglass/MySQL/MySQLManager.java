	...
	public static void setConnection(String host, String user, String password, String database) {
		try {
			if (Skellett.mysqlData.getBoolean("MySQLSetup.SQLite")) {
				con = DriverManager.getConnection(Skellett.mysqlData.getString("ClassPath", "jdbc:mysql://") + host + ":" + Skellett.mysqlData.getInt("MySQLSetup.Port", 3306) + "/" + database + "?allowMultiQueries=" + Skellett.mysqlData.getBoolean("allowMultiQueries", true));
			} else {
				con = DriverManager.getConnection(Skellett.mysqlData.getString("ClassPath", "jdbc:mysql://") + host + ":" + Skellett.mysqlData.getInt("MySQLSetup.Port", 3306) + "/" + database + "?allowMultiQueries=" + Skellett.mysqlData.getBoolean("allowMultiQueries", true), user, password);
			}
