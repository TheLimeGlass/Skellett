		...
		if (object.getSingle(e) instanceof Metadatable) {
			...
			if (mode == ChangeMode.SET) {
				if (metadata.hasMetadata(string.getSingle(e))) {
					metadata.removeMetadata(string.getSingle(e), Skellett.instance);
				}
				metadata.setMetadata(string.getSingle(e), (MetadataValue)new FixedMetadataValue(Skellett.instance, (Object)(delta[0])));
