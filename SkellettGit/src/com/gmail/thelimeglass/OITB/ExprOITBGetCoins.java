...
public class ExprOITBGetCoins extends SimpleExpression<Integer>{
	
	//[OITB] [get] coins of %player%
	...
	public String toString(@Nullable Event e, boolean arg1) {
		return "[OITB] [get] coins of %player%";
	}
	@Override
	@Nullable
	protected Integer[] get(Event e) {
		...
		return new Integer[]{stats.getCoins(player.getSingle(e))};
	}
}