...
public class ExprOITBGetShotsfired extends SimpleExpression<Integer>{
	
	//[OITB] [get] Shots[ ]fired of %player%
	...
	public String toString(@Nullable Event e, boolean arg1) {
		return "[OITB] [get] Shots[ ]fired of %player%";
	}
	@Override
	@Nullable
	protected Integer[] get(Event e) {
		...
		return new Integer[]{stats.getShotsfired()};
	}
}