...
public class ExprOITBGetChallengeWins extends SimpleExpression<Integer>{
	
	//[OITB] [get] Challenge[s][ ](win[s]|won) of %player%
	...
	public String toString(@Nullable Event e, boolean arg1) {
		return "[OITB] [get] Challenge[s][ ](win[s]|won) of %player%";
	}
	@Override
	@Nullable
	protected Integer[] get(Event e) {
		...
		return new Integer[]{stats.getChallengeWins()};
	}
}