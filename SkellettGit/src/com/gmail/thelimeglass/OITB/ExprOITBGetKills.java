...
public class ExprOITBGetKills extends SimpleExpression<Integer>{
	
	//[OITB] [get] kills of %player%
	...
	public String toString(@Nullable Event e, boolean arg1) {
		return "[OITB] [get] kills of %player%";
	}
	@Override
	@Nullable
	protected Integer[] get(Event e) {
		...
		return new Integer[]{stats.getKills()};
	}
}