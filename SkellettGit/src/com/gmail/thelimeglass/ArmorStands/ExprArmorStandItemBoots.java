...
@Syntax({"armo[u]r stand boots of %entity%", "armo[u]r stand %entity%'s boots"})
...
public class ExprArmorStandItemBoots extends SimpleExpression<ItemStack>{
	...
	protected ItemStack[] get(Event e) {
		...
		if (entity.getSingle(e) instanceof ArmorStand) {
			return new ItemStack[]{((ArmorStand)entity.getSingle(e)).getBoots()};
		}
		return null;
	}
	@Override
	public void change(Event e, Object[] delta, Changer.ChangeMode mode){
		...
		if (entity.getSingle(e) instanceof ArmorStand) {
			if (mode == ChangeMode.SET) {
				((ArmorStand)entity.getSingle(e)).setBoots((ItemStack)delta[0]);
			}
		}
	}
	@SuppressWarnings("unchecked")
